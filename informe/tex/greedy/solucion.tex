...
Adicionalmente, el algoritmo será traducido a un lenguaje de progamación más moderno, Python.
...
En cada paso del algoritmo se toma la misma decisión, se elige el vertice no visitado con menor distancia desde el origen, esta regla consituye una
regla Greedy ya que se está tomando una decisión en base a un óptimo local ("cual es la menor distancia a la que me puedo mover"), la cual en conjunto 
