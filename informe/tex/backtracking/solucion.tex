...
\lstinputlisting[language=Python]{code/laberinto.py}

El código del algoritmo se encuentra en \textit{code/laberinto.py}. La función \textit{avanzar} concentra la lógica recursiva del backtracking, mientras que \textit{encontrar\_camino\_bt} busca la posición inicial y actúa como punto de entrada del algoritmo.
